        ...
        <div className="bg-white block items-center lg:grid lg:grid-cols-10 rounded-lg ">
          ...
          <div className="p-4 col-span-8 space-y-4">
            ...
            <div className="flex gap-x-2 items-center">
              ...
              <p className="text-sm text-gray-700">
                {user?.license_type} سال سابقه کار
              </p>
            </div>
            <div className="flex gap-x-2 items-center">
              <p className="text-xs leading-6 text-gray-600">{user?.bio}</p>
            </div>
          </div>
        </div>
              ...
              <table className="table table-zebra text-right">
                <thead>
                  <tr className="bg-white">
                    ...
                    <th className="text-gray-600 text-xs font-light">آدرس</th>
                    <th className="text-gray-600 text-xs font-light">عملیات</th>
                  </tr>
                </thead>
                <tbody>
                  {request.length === 0 ? (
